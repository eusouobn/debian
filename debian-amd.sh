...
sudo dpkg --add-architecture i386 && sudo apt update && sudo apt purge intel-microcode va-driver-all va-driver-all:i386 i965-va-driver i965-va-driver:i386 && sudo apt install --install-recommends -y mesa-va-drivers libegl1-mesa libegl1-mesa-dev libgl1-mesa-dri libgl1-mesa-dri:i386 libgl1-mesa-glx libgl1-mesa-glx:i386 libglapi-mesa libglapi-mesa:i386 libgles2-mesa mesa-utils mesa-vulkan-drivers
