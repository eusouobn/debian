...
sudo apt install -y bluetooth bluez bluez-firmware pavucontrol blueman 

sudo dpkg --add-architecture i386 && sudo apt update && sudo apt purge -y amd64-microcode va-driver-all mesa-va-drivers && sudo apt install --install-recommends -y i965-va-driver libegl1-mesa libegl1-mesa-dev libgl1-mesa-dri libgl1-mesa-dri:i386 libgl1-mesa-glx libgl1-mesa-glx:i386 libglapi-mesa libglapi-mesa:i386 libgles2-mesa mesa-utils mesa-vulkan-drivers
...
sudo apt install -y ttf-mscorefonts-installer fonts-ubuntu fonts-liberation2
